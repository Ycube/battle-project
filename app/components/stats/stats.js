angular.module('lolStats.stats', [])
  ...
  .controller('StatsController', ['$scope', '$filter', 'landingService', function($scope, $filter, landingService) {
   ...
   for (var j = 0; j < $scope.champList.length; j++) {
    ...
    $scope.champ = [{name: "Aatrox", "totalSessionsPlayed": 12, "totalAssists" : 25},
                  {name: "Janna", "totalSessionsPlayed": 10, "totalAssists" : 25}];
  }]);
